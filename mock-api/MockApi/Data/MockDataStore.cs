...
/// <summary>
/// EF Core-based data store that replaces in-memory implementation with SQLite persistence.
/// Maintains the same API as original MockDataStore for backward compatibility.
