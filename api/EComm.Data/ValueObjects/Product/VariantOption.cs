...
/// market <c>ProductAttribute</c> via <see cref="AttributeId"/> with a selected subset of its
/// values — or local, defined inline on the product (<see cref="AttributeId"/> null).
/// </summary>
