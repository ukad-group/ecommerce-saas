    ...
    public static void SeedDatabase(ECommDbContext context)
    {
        ...
        var products = new[]
        {
            ...
            new Product
            {
                ...
                Price = 79.99m,
                Currency = "USD",
                Images = new List<ProductImage> { "https://dummyimage.com/300x300/4A5568/fff.png&text=Headphones" },
            ...
            new Product
            {
                ...
                Price = 199.99m,
                Currency = "USD",
                Images = new List<ProductImage> { "https://dummyimage.com/300x300/3B82F6/fff.png&text=Smart+Watch" },
            ...
            new Product
            {
                ...
                Price = 89.99m,
                Currency = "USD",
                Images = new List<ProductImage> { "https://dummyimage.com/300x300/6366F1/fff.png&text=4K+Webcam" },
            ...
            new Product
            {
                ...
                Currency = "USD",
                Images = new List<ProductImage> { "https://dummyimage.com/300x300/10B981/fff.png&text=T-Shirt" },
            ...
            new Product
            {
                ...
                Price = 59.99m,
                Currency = "USD",
                Images = new List<ProductImage> { "https://dummyimage.com/300x300/2563EB/fff.png&text=Jeans" },
                CategoryIds = new List<string> { "cat-2" },
                Status = "active",
                StockQuantity = 75,
                LowStockThreshold = 10,
            ...
            new Product
            {
                ...
                Price = 129.99m,
                Currency = "USD",
                Images = new List<ProductImage> { "https://dummyimage.com/300x300/DC2626/fff.png&text=Winter+Jacket" },
                CategoryIds = new List<string> { "cat-2" },
                Status = "active",
                StockQuantity = 40,
                LowStockThreshold = 10,
            ...
            new Product
            {
                ...
                Price = 34.99m,
                Currency = "USD",
                Images = new List<ProductImage> { "https://dummyimage.com/300x300/F59E0B/fff.png&text=Desk+Lamp" },
            ...
            new Product
            {
                ...
                Price = 49.99m,
                Currency = "USD",
                Images = new List<ProductImage> { "https://dummyimage.com/300x300/059669/fff.png&text=Garden+Tools" },
                CategoryIds = new List<string> { "cat-3" },
                Status = "active",
                StockQuantity = 35,
                LowStockThreshold = 10,
            ...
            new Product
            {
                ...
                Price = 29.99m,
                Currency = "USD",
                Images = new List<ProductImage> { "https://dummyimage.com/300x300/8B5CF6/fff.png&text=Yoga+Mat" },
            ...
            new Product
            {
                ...
                Price = 149.99m,
                Currency = "USD",
                Images = new List<ProductImage> { "https://dummyimage.com/300x300/16A34A/fff.png&text=Camping+Tent" },
                CategoryIds = new List<string> { "cat-4" },
                Status = "active",
                StockQuantity = 20,
                LowStockThreshold = 10,
            ...
            new Product
            {
                ...
                Price = 39.99m,
                Currency = "USD",
                Images = new List<ProductImage> { "https://dummyimage.com/300x300/0EA5E9/fff.png&text=Programming+Book" },
            ...
            new Product
            {
                ...
                Price = 24.99m,
                Currency = "USD",
                Images = new List<ProductImage> { "https://dummyimage.com/300x300/EC4899/fff.png&text=Cookbook" },
                CategoryIds = new List<string> { "cat-5" },
                Status = "active",
                StockQuantity = 55,
                LowStockThreshold = 10,
