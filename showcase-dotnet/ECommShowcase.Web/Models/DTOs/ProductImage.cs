...
/// <summary>
/// A product image with optional Umbraco-derived metadata. Deserializes from EITHER a bare URL
/// string (legacy shape) or an object, so the storefront keeps working regardless of which shape
/// the API returns. Mirrors the API's ProductImage contract.
/// </summary>
